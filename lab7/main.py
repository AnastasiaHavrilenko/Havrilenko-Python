...
def print_sorted_dictionary(dictionary):
  sorted_keys = sorted(dictionary.keys())  # Сортуємо ключі словника
...
def main():
  ...
  while True:
      ...
      print("5. Вивести вміст словника за відсортованими ключами")
      ...
      if choice == "1":
        print_dictionaary(countries_dictionary) 
          ...
          for country, info in countries_dictionary.items():
           ...
           print_sorted_dictionary(countries_dictionary)
      elif choice == "6":
          break
      else:
